...
class FrontendFilesTest(unittest.TestCase):
    def test_frontend_page_has_quantdinger_shell(self):
        ...
        self.assertIn("策略 IDE", html)
        self.assertIn("实盘监控", html)
        self.assertIn("Paper 订单", html)
        self.assertIn("管理员登录", html)
        self.assertIn("运行回测", html)
        self.assertIn("参数敏感度", html)
        self.assertIn("压力情景", html)
        ...
        self.assertIn('id="authUsername"', html)
        self.assertIn('id="authPassword"', html)
        ...
        self.assertNotIn("knowledgeCard", html)
    ...
    def test_frontend_script_polls_live_state(self):
        ...
        self.assertIn("function apiFetch", js)
        self.assertIn("function submitAuthLogin", js)
        ...
        self.assertIn("[data-order-type]", js)
    ...
    def test_quantdinger_shell_javascript_bindings_exist(self):
        ...
        self.assertIn("function switchPage", js)
    ...
    def test_docker_service_files_exist(self):
        ...
        self.assertIn("TRADE_ADMIN_USERNAME", env_example)
        self.assertIn("TRADE_ADMIN_PASSWORD", env_example)
        self.assertIn("TRADE_API_TOKEN", env_example)

    def test_auth_overlay_styles_are_defined(self):
        css = (ROOT / "web" / "styles.css").read_text(encoding="utf-8")

        self.assertIn(".auth-screen", css)
        self.assertIn(".auth-panel", css)
        self.assertIn(".auth-screen.hidden", css)
